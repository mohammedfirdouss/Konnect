...
def test_endpoint(method: str, endpoint: str, data: dict = None, headers: dict = None, expected_status: int = 200):
...
def test_registration_validation():
    ...
    result = test_endpoint("POST", "/auth/register", {
...
def test_token_validation():
    ...
    # First get a token
    login_result = test_endpoint("POST", "/auth/login", {
        "email": "testuser123@example.com",
        "password": "password123"
    }, expected_status=200)
