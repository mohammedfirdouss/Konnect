...
class TestRecommendationAgent:
    ...
    @patch('konnect.agents.recommendation.InMemorySessionService')
    @patch('konnect.agents.recommendation.Runner')
    @patch('konnect.agents.recommendation.Agent')
    def test_agent_initialization(self, mock_agent_class, mock_runner_class, mock_session_service_class):
    ...
    @patch('konnect.agents.recommendation.Runner')
    @patch('konnect.agents.recommendation.Agent')
    def test_custom_model_initialization(self, mock_agent_class, mock_runner_class, mock_session_service_class):
        ...
        agent = RecommendationAgent(model=custom_model)
    ...
    @patch('konnect.agents.recommendation.Runner')
    @patch('konnect.agents.recommendation.Agent')
    def test_get_recommendations_success(self, mock_agent_class, mock_runner_class, mock_session_service_class):
    ...
    @patch('konnect.agents.recommendation.Runner')
    @patch('konnect.agents.recommendation.Agent')
    def test_get_recommendations_error(self, mock_agent_class, mock_runner_class, mock_session_service_class):
    ...
    @patch('konnect.agents.recommendation.Runner')
    @patch('konnect.agents.recommendation.Agent')
    def test_get_category_recommendations(self, mock_agent_class, mock_runner_class, mock_session_service_class):
    ...
    @patch('konnect.agents.recommendation.Runner')
    @patch('konnect.agents.recommendation.Agent')
    def test_get_budget_recommendations(self, mock_agent_class, mock_runner_class, mock_session_service_class):
...
class TestAgentIntegration:
    ...
    def test_agent_tools_integration(self):
        ...
        popular_electronics = [item for item in popular if item["category"] == "Electronics"]
