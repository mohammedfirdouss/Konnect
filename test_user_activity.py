...
from konnect.agents.recommendation import get_user_activity, get_user_activity_with_db, RecommendationAgent
...
def test_user_relationships(db_session, sample_user, sample_listing):
    ...
    activity = crud.create_user_activity(db_session, activity_data, sample_user.id)
