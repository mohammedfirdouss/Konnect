  ...
  return (
    <section className="py-20 px-4">
      <div className="container mx-auto text-center">
        ...
        <h1 className="text-3xl md:text-6xl font-bold mb-3 text-balance text-white">
          Campus Commerce Powered by Solana.
        </h1>

        <p className="md:text-xl text-[#B1B1B1] mb-10 max-w-5xl mx-auto">
          Konnect is the mobile-first marketplace and payment platform for
          students. Buy, sell, and fund projects with escrow-secured payments in
          SOL and stablecoins.
        </p>
        ...
        <div className="w-full grid grid-cols-1 md:grid-cols-2 md:p-[20px] gap-[20px]  max-w-6xl mx-auto md:bg-[#1E1E1E] rounded-[20px]">
          {features.map((e) => (
            <div
              className="flex flex-col items-center w-full rounded-[20px] p-[20px] bg-[#1E1E1E] border border-[#1E1E1E] lg:w-auto"
              key={e.title}
            >
