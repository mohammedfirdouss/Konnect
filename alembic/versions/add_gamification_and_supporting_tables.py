...
def upgrade():
    ...
    op.create_index(
        op.f("ix_campus_leaderboard_id"), "campus_leaderboard", ["id"], unique=False
    )
    ...
    op.create_index(
        op.f("ix_delivery_codes_id"), "delivery_codes", ["id"], unique=False
    )
    op.create_index(
        op.f("ix_delivery_codes_code"), "delivery_codes", ["code"], unique=True
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "flagged_reasons", sa.Text(), nullable=True
